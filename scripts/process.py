...
def process_dataset(id2text, data_path, save_path):
    fo = open(data_path, "r")
    wtwt = json.load(fo)
    fo.close()
...
process_dataset(id2text, 'wtwt_1.json', 'data_1.json')
process_dataset(id2text, 'wtwt_2.json', 'data_2.json')
process_dataset(id2text, 'wtwt_new.json', 'data_new.json')
